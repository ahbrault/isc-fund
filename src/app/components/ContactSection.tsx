...
const ContactSection: React.FC<ContactSectionProps> = () => {
  return (
    <Section className="pb-2">
      <div className="grid items-center justify-center gap-16 py-20 md:grid-cols-2 md:py-32">
        <Image
        ...
        <div>
          ...
          <p className="mb-4 text-xl font-semibold">
            For any inquiries, please feel free to contact Emmanuel Jayr, Co-founder and Treasurer
            of the ISC Fund, at{' '}
