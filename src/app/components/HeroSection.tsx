    ...
    return (
      <div className="my-8 rounded-lg bg-white/30 p-4 md:hidden">
        <div className="mb-1 mr-2 inline-flex items-center gap-2">
          ...
          <span>•</span>
          <span className="font-medium">July 16th, 2026</span>
        </div>
  ...
  return (
    <div className="mb-8 hidden items-center gap-2 rounded-full bg-white/30 p-1.5 md:inline-flex">
      ...
      <div className="mx-auto mr-2 inline-flex flex-wrap items-center gap-x-1 font-medium">
        <span className="text-sm text-white">July 16th, 2026</span>
      ...
      <div className="flex flex-col items-center gap-4 md:flex-row md:gap-16">
        ...
        <div className="md:order-1">
          ...
          <p className="text-white md:text-lg">
            Sickle cell disease is the world&apos;s most common genetic disorder, affecting over 12
            million people, the disease kills half of children with the severe form before age five,
            predominantly impacting black populations.
          </p>
          <p className="text-white md:text-lg">
